...
export class PerplexityProvider implements AIProvider {
  ...
  private buildPrompt(code: string, issue: ScanIssue, context?: string): string {
...
`.trim();
  ...
  private parseResponse(aiResponse: string, originalCode: string, issue: ScanIssue): AIFixSuggestion {
    // Extract fixed code
