...
const features = [
    ...
    { "id": "string-trim", "name": "String trim methods", "status": { "baseline": "widely", "since": "2019-07" } },
    // Web APIs
    { "id": "abortcontroller", "name": "AbortController", "status": { "baseline": "widely", "since": "2022-03" } },
    { "id": "abortsignal-timeout", "name": "AbortSignal.timeout", "status": { "baseline": "newly", "since": "2022-09" } },
    ...
    // CSS Layout
    { "id": "grid", "name": "CSS Grid Layout", "status": { "baseline": "widely", "since": "2017-03" } },
    { "id": "flexbox", "name": "CSS Flexbox", "status": { "baseline": "widely", "since": "2017-03" } },
    { "id": "flexbox-gap", "name": "Gap in Flexbox", "status": { "baseline": "widely", "since": "2021-04" } },
    { "id": "display-contents", "name": "display: contents", "status": { "baseline": "newly", "since": "2020-01" } },
    // CSS Container Queries
    { "id": "container-queries", "name": "CSS Container Queries", "status": { "baseline": "newly", "since": "2022-09" } },
    // CSS Properties
    { "id": "aspect-ratio", "name": "aspect-ratio property", "status": { "baseline": "widely", "since": "2021-08" } },
    { "id": "accent-color", "name": "accent-color property", "status": { "baseline": "newly", "since": "2021-08" } },
    { "id": "backdrop-filter", "name": "backdrop-filter property", "status": { "baseline": "newly", "since": "2021-03" } },
    { "id": "scroll-behavior", "name": "scroll-behavior property", "status": { "baseline": "widely", "since": "2018-09" } },
    { "id": "scroll-snap", "name": "CSS Scroll Snap", "status": { "baseline": "widely", "since": "2019-09" } },
    { "id": "scroll-timeline", "name": "scroll-timeline property", "status": { "baseline": "limited" } },
    // CSS Color Functions
    { "id": "color-mix", "name": "color-mix() function", "status": { "baseline": "limited" } },
    { "id": "oklch", "name": "oklch() color function", "status": { "baseline": "limited" } },
    { "id": "oklab", "name": "oklab() color function", "status": { "baseline": "limited" } },
    { "id": "lab-colors", "name": "Lab color functions", "status": { "baseline": "limited" } },
    // CSS Selectors
    { "id": "css-has", "name": ":has() pseudo-class", "status": { "baseline": "newly", "since": "2022-12" } },
    { "id": "css-where", "name": ":where() pseudo-class", "status": { "baseline": "newly", "since": "2021-04" } },
    { "id": "css-is", "name": ":is() pseudo-class", "status": { "baseline": "newly", "since": "2021-04" } },
    // CSS Logical Properties
    { "id": "logical-properties", "name": "CSS Logical Properties", "status": { "baseline": "newly", "since": "2021-04" } },
    // CSS View Transitions
    { "id": "view-transitions", "name": "View Transitions API", "status": { "baseline": "limited" } },
    // CSS Nesting
    { "id": "css-nesting", "name": "CSS Nesting", "status": { "baseline": "newly", "since": "2023-03" } }
];
